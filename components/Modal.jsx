    ...
    return (
        ...
        <Transition.Root show={open} as={Fragment}>
           ...
           sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
                    ...
                    <span
                        className='hidden sm:inline-block sm:aling-middle sm:h-screen mt-40'
                        aria-hidden='true'
                    >
                        &#8203;
                    </span>
                    ...
                    >
                        <div className='inline-block aling-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <div>
                                                <input
                                                        //   this is the hook but this reason is the ref    
                                                    ref={filePickerRef}
                                                    type='file'
                                                    hidden
